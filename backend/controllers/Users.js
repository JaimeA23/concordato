...
const calculardatos= (users) => {
    ...
    var mana =((((((((users.raza.intelecto + users.intelecto)*2.5)+((users.raza.poder + users.poder)*2))*2)+(((users.raza.sabiduria + users.sabiduria)+(users.raza.espiritu + users.espiritu))*1.5)+(users.raza.constitucion + users.constitucion)))*1.6)+(users.raza.bon_mana)).toFixed()*1;
    
    var comunion=(((((((users.raza.espiritu + users.espiritu)*5)+((users.raza.sabiduria + users.sabiduria)*2))*2)+((users.raza.fuerza + users.fuerza)+((users.raza.constitucion + users.constitucion)*0.5)+(users.raza.poder + users.poder)))/2.2)+(users.raza.bon_com)).toFixed()*1;
    ...
    if(razaid==8){
        ...
        vida=(((((((users.raza.constitucion + users.constitucion)*2)+(users.raza.fuerza + users.fuerza)+((users.raza.agilidad + users.agilidad)*0.5))*1.3)+(users.raza.espiritu + users.espiritu)+((users.raza.poder + users.poder)*0.5))+(users.raza.bon_salud + users.bon_salud))*((users.raza.frialdad)/10)).toFixed()*1;
